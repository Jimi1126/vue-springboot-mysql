...
import com.iconfluence.sms.model.IcSmsMeetingExample.Criteria;
import com.iconfluence.sms.model.IcSmsMeetingExample.Criterion;
import org.apache.ibatis.jdbc.SQL;

import java.util.List;
import java.util.Map;

public class IcSmsMeetingSqlProvider {
     ...
     * @mbg.generated
     */
    public String countByExample(IcSmsMeetingExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("ic_sms_meeting");
     ...
     * @mbg.generated
     */
    public String deleteByExample(IcSmsMeetingExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("ic_sms_meeting");
        applyWhere(sql, example, false);
        return sql.toString();
    }
     ...
     * @mbg.generated
     */
    public String insertSelective(IcSmsMeeting record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("ic_sms_meeting");
        ...
        if (record.getMeetingTime() != null) {
            sql.VALUES("meeting_time", "#{meetingTime,jdbcType=VARCHAR}");
        }
        
        if (record.getProvience() != null) {
            sql.VALUES("provience", "#{provience,jdbcType=VARCHAR}");
        }
     ...
     * @mbg.generated
     */
    public String selectByExample(IcSmsMeetingExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        IcSmsMeeting record = (IcSmsMeeting) parameter.get("record");
        IcSmsMeetingExample example = (IcSmsMeetingExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("ic_sms_meeting");
        ...
        if (record.getMeetingTime() != null) {
            sql.SET("meeting_time = #{record.meetingTime,jdbcType=VARCHAR}");
        }
        
        if (record.getProvience() != null) {
            sql.SET("provience = #{record.provience,jdbcType=VARCHAR}");
        }
     ...
     * @mbg.generated
     */
    public String updateByPrimaryKeySelective(IcSmsMeeting record) {
        SQL sql = new SQL();
        sql.UPDATE("ic_sms_meeting");
        ...
        if (record.getMeetingTime() != null) {
            sql.SET("meeting_time = #{meetingTime,jdbcType=VARCHAR}");
        }
        
        if (record.getProvience() != null) {
            sql.SET("provience = #{provience,jdbcType=VARCHAR}");
        }
     ...
     * @mbg.generated
     */
    protected void applyWhere(SQL sql, IcSmsMeetingExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
